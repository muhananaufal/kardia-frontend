                ...
                {discussions.length === 0 ? (
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-slate-600 mb-4">
                            Belum ada diskusi yang dibuat. Mulai diskusi baru untuk bertanya atau berbagi pengalaman.
                        </p>
                        <Link
                            to={`/dashboard/program/chat/new?program=${programSlug}&readOnly=${isReadOnly}`}
                    ...
                    <div className="space-y-3">
                        {discussions.map((discussion) => (
                            ...
                            >
                                <Link
                                    to={`/dashboard/program/chat/${discussion.slug}?readOnly=${isReadOnly}`}
                                    className="flex-1"
                                >
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-slate-600 line-clamp-1">
                                                {
                                                    discussion.last_message_snippet
                                                }
                                            </p>
                                            <p className="text-xs text-slate-400 mt-1">
                                                {discussion.last_updated_human}
                                            </p>
                                        </div>
                                    </div>
                                </Link>
