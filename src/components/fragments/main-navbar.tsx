          ...
          >
              ...
              {navItems.map((item) => (
                <motion.button
                  ...
                  className={`relative px-3 py-2 text-sm font-medium transition-colors duration-200 ${
                    activeSection === item.href.substring(1) ? "text-blue-600" : "text-slate-700 hover:text-blue-600"
                  }`}
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
            ...
            <div className="hidden md:block">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  ...
                  className={`bg-gradient-to-r from-blue-500 to-teal-500 hover:from-blue-600 hover:to-teal-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 ${
            ...
            <div className="md:hidden">
              <motion.button
                ...
                className="p-2 rounded-lg text-slate-700 hover:text-blue-600 hover:bg-blue-50 transition-colors duration-200"
              >
            ...
            >
              <div className="px-4 py-6 space-y-4">
                ...
                >
                  <Button
                    onClick={handleTryKardia}
                    className="w-full bg-gradient-to-r from-blue-500 to-teal-500 hover:from-blue-600 hover:to-teal-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    🚀 Try Kardia Free
                  </Button>
                </motion.div>
