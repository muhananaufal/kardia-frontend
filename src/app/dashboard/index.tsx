    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <motion.div variants={cardVariants} initial="initial" animate="animate" transition={{ delay: 0.2 }}>
          <Card className="rounded-2xl shadow-md border-0 bg-gradient-to-br from-emerald-50 to-emerald-100/50 hover:shadow-lg transition-all duration-300">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-emerald-700 text-lg">Status Kesehatan</CardTitle>
        ...
        <motion.div variants={cardVariants} initial="initial" animate="animate" transition={{ delay: 0.3 }}>
          <Card className="rounded-2xl shadow-md border-0 bg-gradient-to-br from-blue-50 to-blue-100/50 hover:shadow-lg transition-all duration-300">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-blue-700 text-lg">Analisis Terakhir</CardTitle>
        ...
        <motion.div variants={cardVariants} initial="initial" animate="animate" transition={{ delay: 0.4 }}>
          <Card className="rounded-2xl shadow-md border-0 bg-gradient-to-br from-purple-50 to-purple-100/50 hover:shadow-lg transition-all duration-300">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-purple-700 text-lg">Trend Kesehatan</CardTitle>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl text-slate-800">
                  Potensi Serangan Jantung dalam 30 Hari Terakhir
                </CardTitle>
                <CardDescription className="text-slate-600">
                  Analisis risiko berdasarkan data kesehatan Anda
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={heartRiskData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <div className="flex items-start gap-3 p-4 rounded-xl bg-yellow-100/60 border border-yellow-200">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-yellow-700 leading-relaxed">
                  Sudah cukup lama sejak analisis terakhir, sebaiknya lakukan pengecekan kembali untuk mengetahui
                  kondisi terkini Anda. Analisis rutin membantu memantau perubahan kesehatan secara dini.
                </p>
              </div>
            </div>
