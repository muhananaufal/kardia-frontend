...
import { Loader2, History, ChevronRight, MessageSquare, Clock, Search, EllipsisVertical, Edit, Trash2 } from 'lucide-react';
		...
		<div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-pink-50">
			<div className="flex">
				...
				<ChatArea
					...
					chatTitle={currentChatId ? chatHistory.find((c) => c.id === currentChatId)?.title || '' : 'AI Chat'}
				/>
