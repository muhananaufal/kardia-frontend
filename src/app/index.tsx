...
import { Heart, Shield, Zap, Users, BarChart3, MessageSquare, History, ChevronDown, ChevronRight, ArrowRight } from 'lucide-react';
						...
						<motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="space-y-8">
							<div className="space-y-6">
								...
								<motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="text-4xl lg:text-6xl font-bold text-slate-900 leading-tight">
									Kardia – Deteksi Dini, <span className="bg-gradient-to-r from-red-500 to-pink-600 bg-clip-text text-transparent">Jaga Jantung</span> Setiap Hari
								</motion.h1>
